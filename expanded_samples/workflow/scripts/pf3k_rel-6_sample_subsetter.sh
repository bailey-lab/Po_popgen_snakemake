...
cd /work/users/k/e/kellybce/ovale1r/snakemake/expanded_samples/input/pf6k_vcfs
...
do vcftools --gzvcf ${i} \
 ...
 --indv QP0048-C \
 --indv PC0295-C \
 --non-ref-ac-any 1 --recode --stdout | gzip -c > ../pf_subset_vcfs/${i%.final.vcf.gz}ov1_no-invariant_sites.vcf.gz;
done

cd /work/users/k/e/kellybce/ovale1r/snakemake/expanded_samples/input/pf_subset_vcfs
