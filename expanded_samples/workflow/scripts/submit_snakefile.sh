cd /work/users/k/e/kellybce/ovale1r/snakemake/expanded_samples
...
#snakemake --use-conda -s workflow/Snakefile_phylogeny.py --cores 30 --profile slurm --rerun-incomplete
