...
poc_chr5_dhfr <- calc_ehh(poc_chr5, mrk = 2108)
...
poc_chr5_dhfr_furcation <- calc_furcation(poc_chr5, mrk = 2108)
...
#Calculate EHH for hit near TS-DHFR
pow_chr5_dhfr <- calc_ehh(pow_chr5, mrk = 1162)
...
pow_chr5_dhfr_furcation <- calc_furcation(pow_chr5, mrk = 1162)
...
poc_chr14_mrp2 <- calc_ehh(poc_chr14, mrk = 5831)
...
poc_chr14_mrp2_furcation <- calc_furcation(poc_chr14, mrk = 5831)
