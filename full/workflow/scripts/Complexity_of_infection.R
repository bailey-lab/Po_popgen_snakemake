...
library("tidyverse")
######setwd("/work/users/k/e/kellybce/ovale1r/novaseq/ov1variants/")

#####file <- snakemake@input
#file <- "ov1_curtisi_masked_biallelicsnps_hardfiltereddefmaf5miss80"
test <- vcfR::read.vcfR(snakemake@input[[1]])
#test <- vcfR::read.vcfR("ov1_curtisi_masked_biallelicsnps_hardfiltereddefmaf5miss80.vcf")
...
invisible(McCOIL_categorical(test_RMCLmat,
                   ...
                   threshold_site=snakemake@params[["threshold_ind"]],
