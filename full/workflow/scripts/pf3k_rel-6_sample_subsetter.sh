...
for i in Pf_60*.vcf.gz;
do vcftools --gzvcf ${i} --indv QG0007-C --indv QG0015-C --indv QG0140-C --indv QG0189-C --indv QG0270-C --indv QS0109-C --indv QS0110-C --indv PE0538-C --indv QS0154-C  --indv QS0159-C --indv QS0168-C --indv QS0169-C --indv QS0170-C --indv QS0157-C --indv QS0133-C --indv PE0129-C --indv PE0130-C --indv PE0109-C --indv PE0113-C --indv QJ0159-C --indv QQ0111-C --indv QJ0008-C --indv QV0030-C --indv QJ0172-C  --non-ref-ac-any 1 --recode --stdout | gzip -c > ${i%.vcf.gz}ov1rsamples_no-invariant_sites.vcf.gz;
done

vcf-concat *ov1rsamples_no-invariant_sites.vcf.gz | bgzip -c > ../../output/vcfs/ov1/ov1_pf3d7_only.vcf.gz
